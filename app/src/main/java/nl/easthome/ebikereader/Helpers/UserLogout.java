...
public class UserLogout {
    ...
    public static void showUserLogoutDialogs(DashboardActivity dashboardActivity) {
        final DashboardActivity context = dashboardActivity;
    ...
    private static void returnToMainActivity(DashboardActivity dashboardActivity) {
        dashboardActivity.startActivity(new Intent(dashboardActivity, MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
    }

    private static void executeLogout(boolean removeServerData, final DashboardActivity context) {
        if (removeServerData) {
